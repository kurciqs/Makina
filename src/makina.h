#ifndef MAKINA_MAKINA_H
#define MAKINA_MAKINA_H
...
//        neural_network_print_numeric_gradients(neural_network, training_data);
    ...
    printf("[LOG] Training for %d iterations took %f seconds with final cost %f.\n\n", training_epochs, time_taken, test_neural_network(neural_network, training_data, num_training_samples));
}
